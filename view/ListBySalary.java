...
class ListBySalary extends JFrame {
    ...
    private JTable tblListBySalary;
    ...
    ListBySalary() {
        ...
        lblTitle = new JLabel("LIST CONTACTS BY SALARY");
        ...
        Contact[] contactArray = ContactController.salarySort();
        ...
        tblListBySalary = new JTable(data, columnNames);
        JScrollPane scrollPane = new JScrollPane(tblListBySalary);
        tblListBySalary.setFillsViewportHeight(true);
